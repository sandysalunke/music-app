...
class Constants {
    ...
    constructor() {
        ...
        this.getPlaylists = `${this.url}/getplaylists`;
        this.getPlaylistSongs = `${this.url}/getPlaylistSongs/{id}`;
        this.updateRating = `${this.url}/updaterating/{id}/{rating}`;
        this.addSongToPlaylist = `${this.url}/addSongToPlaylist`;
        this.createPlaylist = `${this.url}/createPlaylist`;
